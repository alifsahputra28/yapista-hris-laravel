...
@section('content')
    ...
    <div class="page-header">
        <div class="page-block"><div class="row align-items-center"><div class="col-md-12"><ul class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Data Administrasi</li>
        </ul></div></div></div>
    </div>

    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div><h3 class="mb-1">Edit Data Administrasi</h3><p class="mb-0 text-muted">Kelola informasi rekening, pajak, dan kepesertaan BPJS.</p></div>
