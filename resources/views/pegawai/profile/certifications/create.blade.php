...
@section('content')
    <x-page-header title="Tambah Sertifikasi" subtitle="Nama sertifikasi wajib diisi; data lainnya dapat dilengkapi nanti." :breadcrumbs="[['label' => 'Dashboard', 'url' => route('pegawai.dashboard')], ['label' => 'Profil Saya', 'url' => route('pegawai.profile.show')], ['label' => 'Tambah Sertifikasi']]">
