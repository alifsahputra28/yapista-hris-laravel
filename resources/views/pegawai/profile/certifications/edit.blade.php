...
@section('content')
    <x-page-header title="Edit Sertifikasi" subtitle="Perbarui sertifikasi atau kompetensi yang tersimpan." :breadcrumbs="[['label' => 'Dashboard', 'url' => route('pegawai.dashboard')], ['label' => 'Profil Saya', 'url' => route('pegawai.profile.show')], ['label' => 'Edit Sertifikasi']]">
