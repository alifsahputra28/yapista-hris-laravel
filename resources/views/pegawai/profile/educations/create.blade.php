...
@section('content')
    <x-page-header title="Tambah Riwayat Pendidikan" subtitle="Jenjang dan institusi wajib diisi untuk setiap record pendidikan." :breadcrumbs="[['label' => 'Beranda', 'url' => route('pegawai.dashboard')], ['label' => 'Akun', 'url' => route('pegawai.profile.show')], ['label' => 'Tambah Pendidikan']]">
