...
@section('content')
    <x-page-header title="Edit Riwayat Pendidikan" subtitle="Perbarui riwayat pendidikan yang tersimpan pada profil Anda." :breadcrumbs="[['label' => 'Dashboard', 'url' => route('pegawai.dashboard')], ['label' => 'Profil Saya', 'url' => route('pegawai.profile.show')], ['label' => 'Edit Pendidikan']]">
