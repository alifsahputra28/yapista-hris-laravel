<div class="card">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-2"><span class="text-muted">Progress keseluruhan</span><strong>{{ $profileProgress['percentage'] }}%</strong></div>
        <div class="progress mb-4" style="height: 6px;" role="progressbar" aria-label="Progress keseluruhan profil" aria-valuenow="{{ $profileProgress['percentage'] }}" aria-valuemin="0" aria-valuemax="100"><div class="progress-bar" style="width: {{ $profileProgress['percentage'] }}%"></div></div>
