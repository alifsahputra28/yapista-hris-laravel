...
@section('content')
    ...
    >
        <x-slot:actions>
            <a href="{{ route('institutions.create') }}" class="btn btn-primary"><i class="ti ti-plus" aria-hidden="true"></i> Tambah Unit Kerja</a>
        </x-slot:actions>
    </x-page-header>
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('institutions.index') }}" class="row g-3 align-items-end">
                ...
                <div class="col-lg-3 filter-primary-actions">
                    ...
                    @if (request()->filled('search'))<a href="{{ route('institutions.index') }}" class="btn btn-light-secondary">Reset</a>@endif
                </div>
            </form>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="table-actions">
                                        ...
                                        <form action="{{ route('institutions.destroy', $institution) }}" method="POST" data-confirm-title="Hapus Unit Kerja?" data-confirm-message="Unit kerja yang masih digunakan tidak dapat dihapus. Lanjutkan?">
                                            @csrf
                                            @method('DELETE')
