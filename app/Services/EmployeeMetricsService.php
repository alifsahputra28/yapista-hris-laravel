...
class EmployeeMetricsService
{
    ...
    public function counts(): array
    {
        $counts = Employee::query()
            ...
            ->selectRaw("SUM(CASE WHEN verification_status = 'draft' AND profile_review_status != 'submitted' THEN 1 ELSE 0 END) AS draft")
            ->selectRaw("SUM(CASE WHEN verification_status = 'submitted' OR profile_review_status = 'submitted' THEN 1 ELSE 0 END) AS submitted")
